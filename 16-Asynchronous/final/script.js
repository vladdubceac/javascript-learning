...
const renderCountry = function (data, className = '') {
  console.log(data);
  const populationText = getPopulationText(data.population);
...
get3Countries('portugal', 'moldova', 'canada', 'tanzania');
*/
