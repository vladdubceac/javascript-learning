...
const [firstName, lastName] = 'Vlad Dubceac'.split(' ');
...
capitalizeName('vlad dubceac');

// Padding
const message = 'Go to gate 23!';
console.log(message.padStart(20, '+').padEnd(30, '+'));
console.log('Vlad'.padStart(20, '+').padEnd(30, '+'));
...
console.log(maskCreditCard(68453546));
console.log(maskCreditCard(43378463864647384));
console.log(maskCreditCard('334843378463864647384'));
